...
## Documentation
#### How to
Be sure to check premake.lua and the example to see how to setup and link this to a project. It's quite intuitive. Just be sure to include the include directory.
#### Log.h
